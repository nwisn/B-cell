...
abstract: This Rmarkdown notebook performs all of the statistical analysis for the associated manuscript. We included it in an effort to improve reproducibilty and provide full transparency regarding our statistical methods. After downloading the dataset and installing all the required R packages, this entire html file (including all the figures) can be created using Knitr. 
output:
  html_document:
    toc: true
    toc_depth: 4
...
### Separate heatmaps for each biomarker set {.tabset .tabset-pills}
...
#### Temporal clustering of B-cells

```{r heatmap_timeclust_Bcell, fig.height=4.5, cache = TRUE, fig.cap="Figure 6.1a: Temporal clustering of B-cells"}
...
#### Temporal clustering of cytokines

```{r heatmap_timeclust_cytokine, fig.height=5.1, cache = TRUE, fig.cap="Figure 6.1b: Temporal clustering of cytokines"}
...
#### Only Significant B-Cells/Cytokines
...
```{r heatmap_signif_bcells_cytokines, fig.height=4, cache = TRUE, fig.cap="Figure 6.1c: Temporal clustering of significant B-cells and cytokines"}
